...
class UserTest(TestCase):
    ...
    def setUp(self):
        ...
        self.comment_url = 'http://124.220.169.238:8000/api/comment/'  
        self.playlist_test_name = '白色风车'
        self.comment_test_articleid = '19350102052021-12-4 18:45'
    ...
    def test_get(self):
        ...
        ret = requests.get(self.comment_url+'?articleid='+self.comment_test_articleid)
        result = ret.json()
        self.assertEqual(result['ret'],0)
    ...
    def test_post(self):
        ...
        headers = {"content-type":"application/json"}
        json_data = {'userid':'1935010205','articleid':self.comment_test_articleid,'commentcontent':'yjkk'
        ,'commenttime':'2022-1-3 12:12'}
        r = requests.post(self.comment_url,json=json_data,headers=headers)
        result = r.json()
        self.assertEqual(result['ret'],0)
